...
public class Pawn : NetworkBehaviour
{
    ...
    {
        //if (IsServer) return;
        //Debug.Log(clientID + " " + NetworkManager.Singleton.ConnectedClients.Count);
        //transform.SetParent(NetworkManager.Singleton.ConnectedClients[clientID].PlayerObject.transform, false);
